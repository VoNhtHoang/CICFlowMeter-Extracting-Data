...
public class FlowOfflinePane extends JPanel{
    ...
    private void init(){
        fileChooser = new JFileChooser(new File("C:/Users/hoang/Documents/Dataset_KLTN"));
    ...
    private JPanel initFilePane(){
        ...
        btnOutputBrowse.addActionListener(actionEvent -> {
            ...
            if (action == JFileChooser.APPROVE_OPTION) {
                ...
                logger.info("FlowOfflinePane File - selected output {}", outputFile.getPath());
    ...
    private void startReadPcap(){
        ...
        try {
            logger.info("Flow Offline Pane File - ##### NEW RUNNING! #####");
            ...
            worker.addPropertyChangeListener(evt -> {
                ...
                if ("progress".equals(evt.getPropertyName())) {
                    ...
                    logger.info("Flow Offline Pane File - Check State: -> {}", evt.getNewValue());
                    ...
                    logger.info("Flow Offline Pane File - File Count: -> {}", evt.getNewValue());
                    ...
                    logger.info("Flow Offline Pane File - Current File: -> {}", evt.getNewValue());
                    ...
                    // logger.info("Flow Offline Pane File - header: -> {}", header);
            ...
            logger.info("startRead: {} -- Syntax: {}", e.getMessage(), e.getClass());
